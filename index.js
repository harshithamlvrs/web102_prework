...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        gameCard.innerHTML = `
        <img src="${game.img}" alt="${game.name}" style="width: 200px; height: auto;" />
        <h3>${game.name}</h3>
...
function filterUnfundedOnly() {
    ...
    console.log(unfundedGames.length); //to see the result
}
...
const displayStr2 = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} 
games. Currently, ${numUnfunded} ${numUnfunded === 1 ? "game remains" : "games remain"} unfunded. We need 
your help to fund these amazing projects!`;

// create a new DOM element containing the template string and append it to the description container
const paragraph = document.createElement("p");
paragraph.textContent = displayStr2;
